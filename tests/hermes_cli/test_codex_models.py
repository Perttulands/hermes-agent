...
def test_get_codex_model_ids_adds_gpt56_sol_from_gpt55_template(monkeypatch):
    monkeypatch.setattr(
...
def test_forward_compat_adds_gpt56_sol_from_gpt55():
    assert _add_forward_compat_models(["gpt-5.5"]) == ["gpt-5.5", "gpt-5.6-sol"]
